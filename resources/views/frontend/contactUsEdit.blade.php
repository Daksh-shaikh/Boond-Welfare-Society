                ...
                <div class="row">
                    <div class="col-md-12" style="margin-top:-17px;">
                        ...
                        <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                            <div class="form-group">
                                <form role="form" method="post" action="{{route('contact.update')}}">
                                    @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-2" >
                                                ...
                                                <input type="text" name="city" class="form-control"  value="{{$ContactEdit->city}}"/>
                                            ...
                                            <div class="col-md-2" >
                                                ...
                                                <input type="number" name="contactNo" placeholder=" " class="form-control" value="{{$ContactEdit->contactNo}}"/>
                                            ...
                                            <div class="col-md-2" >
                                                ...
                                                <input type="text" name="contactPerson" placeholder=" " class="form-control" value="{{$ContactEdit->contactPerson}}"/>
                                            ...
                                            <div class="col-md-2" style="margin-top:5vh;">
                                                ...
                                                <button style="background-color:#00cc00; border:none; max-height:35px; margin-top: 5px; "  type="submit" class="btn btn-info" data-toggle="tooltip" data-placement="top" data-original-title="" title=""><i class="fa fa-edit" style="margin-left:5px;"></i>Update</button>

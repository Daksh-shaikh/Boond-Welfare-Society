                        ...
                        <div class="panel-body" style="margin-top:-10px; margin-bottom:-5px;">
                            <div class="form-group" style="margin-top: -20px;">
                                    ...
                                    <form action="{{route('announcement.update')}}" method="post">
                                        @csrf
                                    <input type="hidden" name="id" value="{{$noticededit->id}}">
                                        <div class="col-md-12">
                                            <div class="form-group" style="margin-top:-10px;">
                                                ...
                                                <div class="col-md-2" style="margin-top:15px;">
                                                    ...
                                                    <input type="text" name="notice" class="form-control" value="{{$noticededit->notice}}">
                                                </div>

                                               <div class="col-md-2" style="margin-top:15px;">
                                                    <label style="font-weight: bold; font-size: 12px;">Add Details<font color="#FF0000">*</font></label>
                                                  <textarea class="form-control" name="details" type="text" rows="2" cols="30" value="">{{$noticededit->details}}</textarea>
                                                </div>
                                            ...
                                            <table class="table datatable" >
                                                ...
                                                @foreach($noticed as $announcement)
                                                    ...
                                                    <td>{{$announcement->details}}</td>
                                                        ...
                                                        <td>
                                                        <a href="{{route('announcement.update',['announcementStore' =>$announcement])}}">
